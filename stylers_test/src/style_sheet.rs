...
pub fn run_tests() {
    println!("------------------Basic Tests------------------");
    let style = style_sheet_test!("./stylers_test/src/samples/basics.css");
    assert_eq!(
        style.trim(),
    ...
    let style = style_sheet_test!("./stylers_test/src/samples/relations.css");
    assert_eq!(
        style.trim(),
    ...
    let style = style_sheet_test!("./stylers_test/src/samples/pseudo.css");
    assert_eq!(
        style.trim(),
    ...
    let style = style_sheet_test!("./stylers_test/src/samples/at_rules.css");
    assert_eq!(
        style.trim(),
    ...
    let style = style_sheet_test!("./stylers_test/src/samples/special_at_rules.css");
    assert_eq!(
        style.trim(),
    ...
    let style = style_sheet_test!("./stylers_test/src/samples/custom_pseudo.css");
    assert_eq!(
        style.trim(),
